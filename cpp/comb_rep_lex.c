...
Arguments:
  unsigned int *vector; //pointer to the array where the current figure is stored
  const unsigned int n; //length of alphabet
  const unsigned int k; //length of figures
